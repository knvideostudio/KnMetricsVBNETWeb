<%@ Page StylesheetTheme="Default" Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="VeterinaryMetrics.BusinessLayer.AdminDashBoard" %>
    ...
    <table style="width: 600px;" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td style="width: 600px; height: 24px; text-align: left; font-family: Arial; font-size: 16px; color: #006AB6; font-weight: bold;">
                    Dash-Board Version 3.00</td>
			</tr>
	<tr>
			<td style="width: 600px; text-align: left; vertical-align: top; font-family: Verdana; font-size: 13px;">
                <br />
                <ul>
                    <li><a href="dbqeChkPreData.aspx">Check Practice Data</a></li>
                    <li><a href="dbqeCurrentProcess.aspx">Current Processing</a></li>
                    <li><a href="dbqeCurrProcHistory.aspx">Current Processing History</a></li>
                    <li><a href="dbqeDisplayErr.aspx">Display Errors</a></li>
                    <li><a href="dbDropIssue.aspx">Drop Issue</a></li>
                    <li><a href="dbqeReport.aspx">Report Queue</a></li>
                    <li><a href="dbqeReportHistory.aspx">Report Queue History</a></li>
                    <li><a href="dbPreProcess.aspx">Practice Process Results</a></li>   
                </ul>
                <br />
                <br />
                <br />
