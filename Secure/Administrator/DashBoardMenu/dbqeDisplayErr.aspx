<%@ Page StylesheetTheme="Default" Language="VB" AutoEventWireup="false" CodeFile="dbqeDisplayErr.aspx.vb" Inherits="VeterinaryMetrics.BusinessLayer.DisplayError" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>DashBoard - Display Error</title>
</head>
<body>
	...
	<tr>
			<td style="width: 750px; text-align: left; vertical-align: top; font-family: Verdana; font-size: 11px;">
             ...
             >
                 ...
                 <RowStyle BackColor="#EEEEEE" ForeColor="Black" Font-Names="Arial" Font-Size="10px" />
