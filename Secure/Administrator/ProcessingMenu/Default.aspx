<%@ Page StylesheetTheme="AdminPart" Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="VeterinaryMetrics.BusinessLayer.Processing" %>
...
<body style="font-family : Verdana; font-size : 10pt; margin-bottom : 0px; margin-left : 0px; margin-right : 0px; margin-top : 0px;" >
    <form id="frmProcessing" runat="server">
    <div>
  ...
  <tr>
	...
	<tr>
		<td style="width: 600px; text-align: left; vertical-align: top; font-family: Verdana; font-size: 11px;">
         <br />
                <ul>
                    <li><a href="ProAwExclusion.aspx">Build Exclusion List</a></li>
                </ul>
                    <p><a href="ProAwReleased.aspx"></a>&nbsp;</p>
                <br />
                <br />
                <br />
                <br />
